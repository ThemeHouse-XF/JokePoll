...
class ThemeHouse_JokePoll_DataWriter_Helper_JokePoll
{
    ...
    {
        $jokePollIds['first_choice'] = XenForo_Application::get('options')->th_jokePoll_firstChoicePollIds;
    ...
    public static function updateJokePollIdOptions(array $newJokePollIds)
    {
        ...
        $options = array(
            'first_choice' => 'th_jokePoll_firstChoicePollIds'
        );
